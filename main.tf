...
module "eks" {
  ...
  cluster_subnets_id = [ module.networking.public_sub_a_id, module.networking.public_sub_b_id, module.networking.private_sub_a_id, module.networking.private_sub_b_id ]
  ...
  node_group_subnets_id = [module.networking.private_sub_a_id, module.networking.private_sub_b_id]
  environment = "prod"
